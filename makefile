all: obj/main.o obj/buddhaplot.o obj/pointgen.o obj/histogram.o
	clang++ -std=c++11 -L obj obj/pointgen.o obj/histogram.o obj/buddhaplot.o obj/main.o -o bin/collateral-deacon
...
obj/pointgen.o: src/pointgen.cpp src/pointgen.hpp
	clang++ -g -Wall -Wextra -Werror -std=c++11 -I src -c src/pointgen.cpp -o obj/pointgen.o
